          ...
          <div>
            ...
            <div className={styles.text}>
              <p className={styles.textItem}>
                ...
                Практикуме. Этот проект — часть учебного курса, но он создан
          ...
          <aside>
            ...
            <div className={styles.text}>
              <p className={styles.textItem}>
                ...
                <a
                  href="https://github.com/NikitaProgrammer228/foodgram-st"
              ...
              <p className={styles.textItem}>
                Автор проекта:{' '}
                <a href="https://t.me/F252252" className={styles.textLink}>
                  Темников Никита Сергеевич
                </a>
              </p>
            </div>
          </aside>
